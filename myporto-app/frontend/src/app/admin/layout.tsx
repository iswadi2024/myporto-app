    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <div className="flex flex-1">
        ...
        <div className="flex-1 ml-56 flex flex-col min-h-screen">
          ...
          <footer className="ml-0 border-t border-gray-200 bg-white px-8 py-3 flex items-center justify-between text-xs text-gray-400">
            <span>© {new Date().getFullYear()} <strong className="text-gray-600">MyPorto</strong> — Platform Portofolio Digital Indonesia</span>
            <span className="hidden sm:block">Admin Panel v1.0</span>
          </footer>
        </div>
      </div>
    </div>
